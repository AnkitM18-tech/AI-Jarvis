...
class Ui_JarvisUI(object):
    def setupUi(self, JarvisUI):
        ...
        JarvisUI.resize(1123, 855)
        self.centralwidget = QtWidgets.QWidget(JarvisUI)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, 0, 1121, 861))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(".\\../B.G/Black_Template.jpg"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(580, 40, 621, 401))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap(".\\../B.G/Iron_Template_1.gif"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(-180, 160, 641, 491))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap(".\\../VoiceReg/__1.gif"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(30, -50, 471, 331))
        self.label_4.setText("")
        self.label_4.setPixmap(QtGui.QPixmap(".\\initial.gif"))
        self.label_4.setScaledContents(True)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(20, 590, 381, 251))
        self.label_5.setText("")
        self.label_5.setPixmap(QtGui.QPixmap(".\\Health_Template.gif"))
        self.label_5.setScaledContents(True)
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(520, 460, 561, 371))
        self.label_6.setText("")
        self.label_6.setPixmap(QtGui.QPixmap(".\\B.G_Template_1.gif"))
        self.label_6.setScaledContents(True)
        self.label_6.setObjectName("label_6")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(440, 210, 161, 61))
        self.pushButton.setStyleSheet("background-color: rgb(85, 255, 255);\n"
"font: 12pt \"MS Shell Dlg 2\";")
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(440, 290, 161, 61))
